...
namespace DatabaseEditorSF.Views {
	public partial class FormControlPanel : Form {
		...
		private void toggleServerState(bool isRunning, Button btn, PictureBox pb) {
			if(isRunning) {
				btn.BackgroundImage = DatabaseEditorSF.Properties.Resources.iconStopButton;
				pb.BackgroundImage  = DatabaseEditorSF.Properties.Resources.iconAdd;
			} else {
				btn.BackgroundImage = DatabaseEditorSF.Properties.Resources.iconPlayButton;
				pb.BackgroundImage  = DatabaseEditorSF.Properties.Resources.iconDelete;
			} 
		}
