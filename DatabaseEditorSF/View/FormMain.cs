...
using DatabaseEditorSF.Classes.AccountTab;
using DatabaseEditorSF.Classes.CharacterTab;
using DatabaseEditorSF.Classes.CreatureTab;
using DatabaseEditorSF.Classes.QuestTab;
using DatabaseEditorSF.Classes.GameObjectTab;
using DatabaseEditorSF.Classes.ItemTab;
using DatabaseEditorSF.Classes.Database;
using DatabaseEditorSF.Classes.Settings;
using DatabaseEditorSF.Classes.Generate;
using DatabaseEditorSF.Classes;
...
namespace DatabaseEditorSF.Views {
	public partial class FormMain : Form {
		...
		// - - - - - - - - - - - MUST READ - - - - - - - - - - -
		//       Welcome to the Source Code of DatabaseEditorSF-TC!
		// - - - - - - - - - - - - - - - - - - - - - - - - - - -
		...
		// http://emudevs.com/showthread.php/5261-Trinity-DatabaseEditorSF-Manager
		// The newest Source Code can be found at Github:
		// https://github.com/Heitx/DatabaseEditorSF-TC
		// - - - - - - - - - - - - - - - - - - - - - - - - - - -
		...
		private void FormMain_Load(object sender, EventArgs e) {
			this.Icon = Properties.Resources.iconDatabaseEditorSF;
