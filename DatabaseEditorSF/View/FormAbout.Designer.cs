namespace DatabaseEditorSF.Views {
	partial class FormAbout {
		...
		private void InitializeComponent() {
			...
			this.labelAboutDatabaseEditorSF.BackColor = System.Drawing.SystemColors.Control;
			this.labelAboutDatabaseEditorSF.Location = new System.Drawing.Point(9, 115);
			this.labelAboutDatabaseEditorSF.Name = "labelAboutDatabaseEditorSF";
			this.labelAboutDatabaseEditorSF.Size = new System.Drawing.Size(318, 13);
			this.labelAboutDatabaseEditorSF.TabIndex = 2;
			this.labelAboutDatabaseEditorSF.Text = "DatabaseEditorSF (Manager) is a database editor, specifically for Trinity 3.3.5a.\r\n";
			// 
			...
			this.linkLabelAboutSource.Text = "PROJECT DatabaseEditorSF -> GITHUB";
